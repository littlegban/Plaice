...
and the bottom half is where components with nubbed connectors get inserted. This is based upon the geometry of [beams](/docs/components/Beams.md):
...
nut from external [M2 bolts](/docs/design/M2Bolts.md). 
...
To ensure the compliant clips stay functional after repeated use, a finite element analysis of the strains experienced
...
has exactly the same width as its maximum width up above. This is to give extra clearance to the tips of connected
...
However, there are exceptions -- for one, the central octagonal island on the nubbed connector is given more clearance from
...
because the clip is compliant, and having fixed geometry simplifies the analysis of the clip's strength. The nub does
...
Plaice socket. The gap allows for a bit of pre-load to be generated by tightened [M2 bolts](/docs/design/M2Bolts.md), if desired. Additionally, the gap allows for Plaice sockets
...
<img src="/docs/images/thrunubs/thrunubbottomwithsupports.webp" alt="Thru-nub Bottom, Showing Mouse Ears" width="256" height="256"> <img src="/docs/images/beams/keyaccessbeamsupportsbottom.webp" alt="Key-access beam, showing supports on bottom" width="256" height="256">
